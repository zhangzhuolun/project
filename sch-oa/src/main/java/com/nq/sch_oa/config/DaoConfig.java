...
import com.nq.sch_oa.config.DataSourceConfig;
import com.nq.sch_oa.config.DaoConfig;
import com.nq.sch_oa.dao.hibernate.impl.CP_Hibernate4DAOImpl;
import com.nq.sch_oa.dao.hibernate.impl.CP_StaffingProveDaoImpl;
...
public class DaoConfig {
	...
	String hibernate_default_schema;
	...
	*/  
	...
	public LocalSessionFactoryBean localSessionFactoryBean() {
		...
		String[] packagesToScan = new String[] { "com.nq.sch_oa.function.**.model.oracle" };
		sessionFactory.setPackagesToScan(packagesToScan);

		Properties hibernateProperties = new Properties();
		hibernateProperties.setProperty("hibernate.default_schema", hibernate_default_schema);
	...
	@Bean(name = "staffingProveDao")
	public CP_StaffingProveDaoImpl staffingProveDao() {
		logger.info("staffingProveDao");
		CP_StaffingProveDaoImpl dao = new CP_StaffingProveDaoImpl();
		dao.setHibernate4DAOImpl(hibernate4Dao());
		return dao;
	}
