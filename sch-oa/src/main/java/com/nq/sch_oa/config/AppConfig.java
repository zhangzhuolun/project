...
*/  
@Configuration
@ComponentScan(basePackages = "com.nq.sch_oa.function", excludeFilters = { @ComponentScan.Filter(type = FilterType.ANNOTATION, value = { Controller.class }) })
...
public class AppConfig {
	/*
	 * 
	 * <!-- 激活自动代理功能 参看：com.pccw.solutions.ark.function.aop.aspect.DemoAspect -->
