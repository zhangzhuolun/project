...
import com.nq.sch_oa.core.CP_InitializingInterceptor;
import com.nq.sch_oa.core.CP_PropertyEditorRegistrar;
import com.nq.sch_oa.core.CP_SimpleMappingExceptionResolver;



@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "com.nq.sch_oa.function", useDefaultFilters = false, includeFilters = {
